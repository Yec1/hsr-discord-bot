...
const langs: LanguageStrings = {
	...
	automimo_On: "已開啟自動 Mimo 任務",
	automimo_Off: "已關閉自動 Mimo 任務",
	automimo_Desc: "機器人將每小時為您檢查並完成 Mimo 任務。\n標註狀態：`<z>`",
	mimo_Title: "Mimo 旅途任務完成",
	mimo_Success: "成功為您的帳號完成了 <count> 個 Mimo 任務並領取了積分！",
	element_physical: "物理",
	element_ice: "冰",
	element_fire: "火",
	element_lightning: "雷",
