...
const langs: LanguageStrings = {
	...
	profile_EffectiveLines: "有效词条：{effective} / {total}",
	profile_EffectiveStatsTitle: "有效副属性命中统计",
	profile_EffectiveStatsTotal: "组计命中",
	profile_CookieExpiredFallbackToUid:
		"Cookie 已过期，目前改用 UID 查询，无法获取全部角色数据。请重新设置 Cookie 以使用完整角色查询。",
	...
	account_CookieInvalidOrExpired: "Cookie 已过期或无效，请重新取得有效的 Cookie 后再试。",
	...
	autoRedeem_On: "已开启自动 redeem",
	autoRedeem_Tag: "兌換時提及：<z>",
	automimo_On: "已开启自动 Mimo 任务",
	automimo_Off: "已关闭自动 Mimo 任务",
	automimo_Desc: "机器人将每小时为您检查并完成 Mimo 任务。\n标注状态：`<z>`",
	mimo_Title: "Mimo 旅途任务完成",
	mimo_Success: "成功为您的账号完成了 <count> 个 Mimo 任务并领取了积分！",
	element_physical: "物理",
	element_ice: "冰",
	element_fire: "火",
	element_lightning: "雷",
	...
	property_ElationAddedRatio: "欢愉伤害加成",
	property_Joy: "欢愉伤害加成",
